                ...
                <div class="profile-container">
                    <div class="profile-header">
                        <div class="moderator-label">
                            ...
                            <div class="admin-change" onclick="addModerator(this, <?php echo $up['id']; ?>, <?php echo $p['moderator']; ?> );">
