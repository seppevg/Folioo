...
class User implements iUser
{
    ...
    public function save()
    {
        ...
        $conn = DB::getInstance();
        $statement = $conn->prepare("INSERT INTO users (email, password, username, image, admin, moderator, warning) VALUES (:email, :password, :username, 'profiledefault.svg', 0, 0, 0);");
        $statement->bindValue(':email', $this->email);
